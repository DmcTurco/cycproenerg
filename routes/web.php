...
Route::prefix(MyApp::COMPANIES_SUBDIR)->middleware('auth:company')->name('company.')->group(function () {
    ...
    Route::resource('technicals.requests', Company\SolicitanteTecnicoController::class);
    Route::post('technicals-getrecords-request', [Company\SolicitanteTecnicoController::class, 'obtenerRegistros'])->name('obtenerRegistros');
