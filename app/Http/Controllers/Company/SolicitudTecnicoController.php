...
class SolicitudTecnicoController extends Controller
{
    public function index($tecnicoID) {
        ...
        $tipoClientes = ['RESIDENCIAL', 'MULTIFAMILIAR', 'COMERCIAL'];

        return view('company.pages.solicitudesTecnico.index', compact('solicitudes', 'tecnico', 'tipoClientes'));
    }
    ...
    public function store($tecnicoID, Request $request) {
        ...
        if (!empty($solicitudID)) {
            ...
            $solicitud = SolicitudTecnico::find($solicitudID);
            ...
            $solicitud = SolicitudTecnico::create([
    ...
    public function edit($tecnicoID, $solicitudID) {
        ...
        $tecnico = Tecnico::findOrFail($tecnicoID);
        $solicitud = SolicitudTecnico::findOrFail($solicitudID);
